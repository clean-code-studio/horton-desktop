...
pub fn init() -> Menu {
  ...
  let app_menu = Submenu::new(
    ...
    Menu::with_items([
      ...
      CustomMenuItem::new("about".to_string(), "About HortonDesktop").into(),
  ...
  let preferences_menu = Submenu::new(
    ...
    Menu::with_items([
      ...
      CustomMenuItem::new("go_conf".to_string(), "Go to Config")
        ...
        .into(),
      CustomMenuItem::new("restart".to_string(), "Restart HortonDesktop")
        .accelerator("CmdOrCtrl+Shift+R")
        .into(),
      CustomMenuItem::new("clear_conf".to_string(), "Clear Config").into(),
      MenuItem::Separator.into(),
      CustomMenuItem::new("horton_housing_dashboard".to_string(), "Horton Housing Admin Application").into(),
...
pub fn menu_handler(event: WindowMenuEvent<tauri::Wry>) {
  ...
  match menu_id {
    ...
    "app_website" => window::cmd::wa_window(
      app,
      "app_website".into(),
      "Horton User's Guide".into(),
      conf::APP_WEBSITE.into(),
      None,
    ),
    "horton_dashboard_app" => open(&app, conf::HORTON_DASHBOARD_APP.to_string()),
    ...
    "scroll_bottom" => win
      ...
      .unwrap(),
    // Help
    "horton_log" => utils::open_file(utils::app_root().join("horton.log")),
