...
//   while (true) {
//     if (window.location.href === 'https://www.mopublicnotices.com/(S(wcvlwvy4gyyzekdilmwvclqv))/authenticate.aspx') {
//       // Step 1
//       stepOne();
...
//       // Step 3
//       const stepThreeContext = stepThree();
//       if (!stepThreeContext.inProcess && !stepThreeContext.succeeded && !stepThreeContext.failure) {
//         stepThreeContext.process();
//       }
//     }
...
// function stepOne() {
//   window.auth = { username: 'zhorton999@gmail.com', password: 'r3dh3lm3t' };
// }

// function stepTwo() {
//   document.querySelectorAll('input[type=email]')[0].value = window.auth.username;
//   document.querySelectorAll('input[type=password]')[0].value = window.auth.password;
// }

// function stepThree() {
//   const context = {
//     process: () => document.querySelectorAll('input[type=submit]')[1].click(),
//     inProcess: false, // Set to true when the process is in progress
//     succeeded: false, // Set to true when the process has succeeded
//     failure: false, // Set to true when the process has failed
//   };
...
async function init() {
  // if (window.location.pathname === '/(S(wcvlwvy4gyyzekdilmwvclqv))/authenticate.aspx') {
    // 
  // }
