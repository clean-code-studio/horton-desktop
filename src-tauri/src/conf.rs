...
pub const ISSUES_URL: &str = "https://github.com/clean-code-studio/horton-desktop/issues";
pub const HORTON_DASHBOARD_APP: &str = "https://github.com/horton-desktop/horton-housing-dashboard";
pub const UPDATE_LOG_URL: &str = "https://github.com/clean-code-studio/horton-desktop/blob/main/UPDATE_LOG.md";
pub const BUY_COFFEE: &str = "https://www.buymeacoffee.com/lencx";
pub const GITHUB_PROMPTS_CSV_URL: &str =
  "https://raw.githubusercontent.com/f/awesome-chatgpt-prompts/main/prompts.csv";

pub const APP_CONF_PATH: &str = "horton.conf.json";
pub const MISSOURI_NOTICES_URL: &str = "https://www.mopublicnotices.com/(S(wcvlwvy4gyyzekdilmwvclqv))/authenticate.aspx";
...
impl AppConf {
  pub fn new() -> Self {
    ...
    Self {
      ...
      tray_width: 360.0,
      tray_height: 540.0,
      main_origin: MISSOURI_NOTICES_URL.into(),
      tray_origin: MISSOURI_NOTICES_URL.into(),
      default_origin: MISSOURI_NOTICES_URL.into(),
